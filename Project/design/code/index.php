            ...
            <div class="container-fluid footer" id="footerBox">
                <div class="container" id="homeBox">
                    <button id="homeBtn" onclick="window.location.href='index.php'">
                        <a href="index.php">
                            <i class="far fa-list-alt fa-2x" style="color: rgba(0, 0, 0, 0.9)"></i>
                        </a>
                    </button>
                    <button id="homeBtn2" onclick="window.location.href='index.php'">
                        <a href="index.php">
                            <i class="far fa-list-alt fa-lg" style="color: rgba(0, 0, 0, 0.9)"></i>
                        </a>
                    </button>
                    <button id="homeBtn3" onclick="window.location.href='index.php'">
                        <a href="index.php">
                            <i class="far fa-list-alt fa-3x" style="color: rgba(0, 0, 0, 0.9)"></i>
                        </a>
                    </button>
                </div>
